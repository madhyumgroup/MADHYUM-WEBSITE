...
// This is the confirmed working Google Apps Script Web App /exec URL.
const MADHYUM_INQUIRY_API_URL = window.MADHYUM_INQUIRY_API_URL || 'https://script.google.com/macros/s/AKfycbzRgbrdHLtZO6MB-WjazHCqHfQtVEeANQHrCet1Ag/exec';
...
const requirement = page==='contact.html'
  ? fieldValue(form,'category')
  : (pageWing[page] || form.getAttribute('data-form-name') || 'General / Other');
...
document
.querySelectorAll('[data-form-name]')
.forEach(form=>
